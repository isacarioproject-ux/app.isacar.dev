...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Click 'Iniciar sesión' button to log in or proceed to next module
        ...
        # -> Try inputting email into the correct input field index 5 and password into index 6, then click 'Iniciar sesión' button to login.
        frame = context.pages[-1]
